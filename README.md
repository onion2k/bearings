...
own run in to a lip over its bowl and its own ramp out from under the hole, so every pair joins, and every pair is raced. The game remembers which run you last played and your best on
